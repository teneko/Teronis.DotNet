...
namespace Teronis.NetStandard.Extensions
{
	...
	{
        public static IEnumerable<ENUM_TYPE> CrushContainingBitsToEnumerable<ENUM_TYPE>(this ENUM_TYPE enumValue, bool ignoreZero = Constants.IgnoreZeroWhenCrushingContainingBits) where ENUM_TYPE : struct, IComparable, IFormattable, IConvertible
        {
        ...
        public static ENUM_TYPE[] CrushContainingBitsToArray<ENUM_TYPE>(this ENUM_TYPE enumValue, bool ignoreZero = Constants.IgnoreZeroWhenCrushingContainingBits) where ENUM_TYPE : struct, IComparable, IFormattable, IConvertible

...
using NSwag;
using Teronis.AspNetCore.Identity.Bearer.NSwag;
using Teronis.AspNetCore.Identity.AccountManaging.Controllers;
using Teronis.AspNetCore.Identity.Bearer.SignInManaging.Controllers;
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints => {
                ...
                endpoints.Map("/", (context) => context.Response.WriteAsync("Hello Teronis.AspNetCore.Identity"));
            });
        }
    }
}

...
namespace Teronis.Diagnostics
{
    public static class IDebuggerDisplayLibrary
    {
        ...
        /// </summary>
        public const string FullGetDebuggerDisplayMethodPathWithParameterizedThis = "{" + nameof(Teronis) + "." + nameof(Diagnostics) + "." + nameof(IDebuggerDisplayTools) + "." + nameof(IDebuggerDisplayTools.GetDebuggerDisplay) + "(this)}";
    }
}

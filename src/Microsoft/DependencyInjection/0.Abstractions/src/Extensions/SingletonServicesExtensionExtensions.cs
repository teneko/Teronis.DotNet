...
{
    public static class SingletonServicesExtensionExtensions
    {
        internal static IServiceCollectionAdapter<TCollection> CreateServiceCollectionAdapter<TServiceBase, TDescriptor, TCollection>(
            this SingletonServicesExtension<TServiceBase, IServiceProvider, TDescriptor, TCollection> extension)

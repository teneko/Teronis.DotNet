...
{
    internal sealed class JSComponentFacades : IJSComponentFacades
    {
        public int Count =>
            jsFacades.Count;
        ...
        public JSComponentFacades(List<IAsyncDisposable> jsFacades, IJSFacadeResolver jsFacadeResolver)
        {
        ...
        public JSComponentFacades(IJSFacadeResolver jsFacadeResolver)
        {

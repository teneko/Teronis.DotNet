...
namespace Teronis.Identity.Extensions
{
    public static class IServiceResultExtensions
    {
        ...
        /// </summary>
        public static bool Succeeded([DisallowNull]this IServiceResult serviceResult, IEnumerable<string> ignoredErrorCodes)
        {
        ...
        public static bool Succeeded([DisallowNull]this IServiceResult serviceResult, params string[] excludeErrorCodes) =>

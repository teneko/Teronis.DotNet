...
namespace Teronis.Identity.Presenters
{
    public static class JsonErrorsExtensions
    {
        ...
        public static Exception ToSingleOrAggregatedOrDefaultException(this JsonErrors? jsonErrors) =>
            ToSingleOrAggregatedException(jsonErrors) ?? new Exception(StringResources.DefaultErrorMessage);
        ...
        /// <param name="error"></param>
        /// <returns></returns>
        public static IServiceResultFactory<ServiceResult<ContentType>, ContentType> ToServiceResultFactory<ContentType>(this JsonErrors? errors)
        {

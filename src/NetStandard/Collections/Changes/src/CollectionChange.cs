...
namespace Teronis.Collections.Changes
{
    ...
    public class CollectionChange<OldItemType, NewItemType> : ICollectionChange<OldItemType, NewItemType>, IDebuggerDisplay
    {
        ...
        public CollectionChange(NotifyCollectionChangedAction changeAction, [AllowNull] OldItemType oldItem, int oldIndex, IReadOnlyList<NewItemType> newItems, int newIndex)

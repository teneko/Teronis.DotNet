...
namespace Teronis.Collections.Specialized
{
        ...
        where KeyType : notnull
    {
        ...
        internal static void RemoveBucketListNode(LinkedBucketListNode<KeyType, ValueType> node)
        {
        ...
        public abstract void AddFirst([AllowNull] KeyType key, LinkedBucketListNode<KeyType, ValueType> node);
        public abstract LinkedBucketListNode<KeyType, ValueType> AddFirst([AllowNull] KeyType key, ValueType value);

        public abstract void AddLast([AllowNull] KeyType key, LinkedBucketListNode<KeyType, ValueType> node);
        public abstract LinkedBucketListNode<KeyType, ValueType> AddLast([AllowNull] KeyType key, ValueType value);
        ...
        public bool TryGetBucket(StillNullable<KeyType> key, [MaybeNullWhen(false)] out LinkedBucketListBase<KeyType, ValueType> bucket)
        {
        ...
        bool ILinkedBucketList<KeyType, ValueType>.TryGetBucket(KeyType key, out ILinkedBucketList<KeyType, ValueType> bucket)
        {
            if (TryGetBucket(key, out var _bucket)) {
                bucket = _bucket;
                return true;
            }
        ...
        public bool TryGetBucket([AllowNull] KeyType key, [MaybeNullWhen(false)] out LinkedBucketListBase<KeyType, ValueType> bucket)
        {
            if (buckets.TryGetValue(key, out var foundBucket)) {
                bucket = foundBucket;
                return true;
        ...
        bool ILinkedBucketList<KeyType, ValueType>.TryGetBucket(StillNullable<KeyType> key, out ILinkedBucketList<KeyType, ValueType> bucket)
        {
            if (TryGetBucket(key, out var _bucket)) {
                bucket = _bucket;
                return true;
        ...
        public void RemoveFirst(ValueType value)
        {
        ...
        public virtual void Remove(LinkedBucketListNode<KeyType, ValueType> node)
        {
            ValidateNodeToBeAttached(this, node);
            RemoveBucketListNode(node);
        }

        public void RemoveFirst()
        {
            if (head == null) {
                throw new InvalidOperationException("Linked list is emoty.");
            }

            RemoveBucketListNode(head);
        }
        ...
        public void RemoveLast()
        {
            ...
            RemoveBucketListNode(previousNode);
        }

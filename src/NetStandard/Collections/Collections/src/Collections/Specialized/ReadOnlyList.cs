...
namespace Teronis.Collections.Specialized
{
    public class ReadOnlyList<ItemType> : IReadOnlyList<ItemType>, IList<ItemType>, IList
    {
        ...
        private readonly IList<ItemType> thisAsListGenericInterface;
        private readonly ICollection thisAsCollectionInterface;
        ...
        public ReadOnlyList(IReadOnlyList<ItemType> readOnlyList)
        {
            ...
            thisAsListGenericInterface = this;
            thisAsCollectionInterface = this;
        }
        ...
        void ICollection<ItemType>.CopyTo(ItemType[] array, int arrayIndex) =>
            thisAsCollectionInterface.CopyTo(array, arrayIndex);
        ...
        bool IList.Contains(object value) => thisAsListGenericInterface.Contains((ItemType)value);
        int IList.IndexOf(object value) => thisAsListGenericInterface.IndexOf((ItemType)value);

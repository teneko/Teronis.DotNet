...
namespace Teronis.Collections.Generic
{
    public static class SuccessivKeys
    {
        ...
        /// <exception cref="SuccessivKeysNonNullableKeyException">Key type is not nullable although key is null.</exception>
        [return: MaybeNull]
        public static KeyType Retype<KeyType>(object?[] keys, int index)
        {
            ...
            try {
                ...
                throw new SuccessivKeysNonNullableKeyException(index, $"Key at index {index} of one array is null, but the type of that key is not nullable.");
            }
        }
    }
}

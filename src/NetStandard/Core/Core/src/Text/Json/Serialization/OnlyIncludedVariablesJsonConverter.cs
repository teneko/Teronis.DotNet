...
{
    public class OnlyIncludedVariablesJsonConverter<T> : JsonConverter<T>, IVariablesClusionHelper
    {
        ...
        public OnlyIncludedVariablesJsonConverter(IEnumerable<KeyValuePair<Type, string>> includedVariables) =>
